...
const productsValidator = require('../middlewares/validators/productsValidator');
...
router.post('/', productsValidator.create, productsController.store); // Acción de creación
router.get('/:id/edit', productsController.edit); // Formulario de edición
router.put('/:id', productsValidator.update, productsController.update); // Acción de edición
